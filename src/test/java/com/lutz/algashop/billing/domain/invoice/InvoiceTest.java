...
import static com.lutz.algashop.billing.domain.invoice.InvoiceTestBuilder.*;
...
class InvoiceTest {
    ...
    void changePaymentSettings_shouldUpdateMethodAndCreditCardId() {
        ...
        assertThat(invoice.getPaymentSettings().getMethod()).isEqualTo(
            PaymentMethod.CREDIT_CARD
        );
        assertThat(invoice.getPaymentSettings().getCreditCardId()).isEqualTo(
            creditCardId
        );
    }
    ...
    void assignPaymentGatewayCode_shouldSetGatewayCode() {
        ...
        assertThat(invoice.getPaymentSettings().getGatewayCode()).isEqualTo(
            "gateway-code-123"
        );
    }
